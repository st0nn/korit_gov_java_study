...
import java.util.Scanner;
    /*
    나이를 입력받고 검증 함수를 통해 확인
    1. 입력받을 때 nextInt로 받게 될텐데 문자열을 넣게 됐을때의 예외처리도 함께 => "숫자가 아닙니다, 정수를 입력해주세요" 출력
    2. 검증 함수에서 예외 발생 시 => "예외 발생 : **에러메세지**" 출력
    3. 마지막은 예외 발생여부 상관없이 "검증 종료" 출력
     */
